  ...
  >
    ...
    >
      ...
      <input
        ...
        required
        class="w-full bg-transparent border border-white/15 rounded-full px-4 py-3 text-sm text-white placeholder:text-white/40 focus:outline-none focus:border-white/35 transition-colors"
      />
      <input
        type="email"
        name="email"
