	...
	const feedbacks = [
		{
			...
			text: "Since I got a site built for my shop from Sarathi Studio, I have seen a lot of positive changes in my business and I am very impressed with their site building and work style.",
		},
		{
			name: "Sanika",
			role: "",
